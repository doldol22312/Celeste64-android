...
*/
    ...
    public void loadLibraries() {
       SDL.loadLibrary("fmod");
       SDL.loadLibrary("fmodstudio");
    ...
    /**
     * This method runs the application entry point.
     * Celeste64's managed Android activity overrides it and runs the .NET game loop.
     */
    ...
    protected void configureFullscreenWindow() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v(TAG, "FMOD initialized: " + org.fmod.FMOD.checkInit());
                    ...
                    if (context instanceof Activity) {
                        ...
                        if (window != null) {
                            if ((msg.obj instanceof Integer) && ((Integer) msg.obj != 0)) {
                                ((SDLActivity) context).configureFullscreenWindow();
                            } else {
...
class SDLMain implements Runnable {
    ...
    public void run() {
        ...
        SDLActivity.mSingleton.runMain();
